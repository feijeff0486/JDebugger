...
public final class DefaultErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final CatcherConfig config = CustomActivityOnCrash.getConfigFromIntent(getIntent());
        ...
        if (config.isShowErrorDetails()) {
            moreInfoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (textView != null) {
                        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.crash_error_activity_error_details_text_size));
                    }
                }
            });
        } else {
    ...
    private void copyErrorToClipboard() {
        ...
        if (clipboard != null) {
            ...
            Toast.makeText(DefaultErrorActivity.this, R.string.crash_error_details_copied, Toast.LENGTH_SHORT).show();
        }
    }
}