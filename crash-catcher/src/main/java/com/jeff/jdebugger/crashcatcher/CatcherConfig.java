 ...
 */
public class CatcherConfig implements Serializable {

    @IntDef({BackgroundMode.BACKGROUND_MODE_CRASH,
            BackgroundMode.BACKGROUND_MODE_SHOW_CUSTOM,
            BackgroundMode.BACKGROUND_MODE_SILENT})
    @Retention(RetentionPolicy.SOURCE)
    public @interface BackgroundMode {
        int BACKGROUND_MODE_SILENT = 0;
        int BACKGROUND_MODE_SHOW_CUSTOM = 1;
        int BACKGROUND_MODE_CRASH = 2;
    }

    private @BackgroundMode int backgroundMode = BackgroundMode.BACKGROUND_MODE_SHOW_CUSTOM;
    ...
    public @BackgroundMode int getBackgroundMode() {
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            CatcherConfig currentConfig = CustomActivityOnCrash.getConfig();

            CatcherConfig config = new CatcherConfig();
